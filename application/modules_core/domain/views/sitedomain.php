    ...
    <div class="optionPane">
        ...
        <div class="product-purchased" id="domain-name">
            <form method="POST" name="quickbuy_domain" id="select-product" novalidate="novalidate">
                ...
                <div class="dca-search">
                    ...
                    <div class="tld-container">
                        ...
                        <div class="tld-select" id="tld" style="display: none;clear:both;">
            ...
            <div id="domain_result" class="results-wrapper" style="display: none">
                ...
                <form method="POST" name="buy_domain" id="book-domain-form" novalidate="novalidate" action="<?php echo site_url('domain/buy_domain'); ?>">
...
<?php
if (isset($premiumDomain) && $premiumDomain == TRUE) {
    ?>
    <div id="siteSettingsWrapper" class="siteSettingsWrapper container-fluid">				
