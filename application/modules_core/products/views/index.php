...
foreach ($result as $res) {
    ...
    <div class="row">
        ...
        <div class="col-md-2 col-sm-4  col-xs-6">
            ...
            <input type="number" name="quantity" id="quantity" min="1" max="5000" value="1" onchange="changettl(this.value)" onkeyup="changettl(this.value)" class="form-control">
...
<script>
    ...
    {
        var sanitized = value.replace(/[^0-9]/g, '1');
        ...
        $('#quantity').removeClass('emptyfield');
    }
</script>
...
<script>
    ...
    function savedata()
    {
        ...
        if (firstname == "" || lastname == "" || email == "" || phone == "" || amount == "" || blng_street == "" || blng_city == "" || blng_country == "" || blng_state == "" || blng_zipcode == "" || spng_street == "" || spng_city == "" || spng_country == "" || spng_state == "" || spng_zipcode == "" || quantity == "")
        {
            alert("Please enter all highlighted fields");

            if (quantity == "") {
                $('#quantity').addClass('emptyfield');
            }
            if (firstname == "") {
            ...
            if (amount == "") {
                $('#amount').addClass('emptyfield');
            }
            if (blng_street == "") {
                $('#blng_street').addClass('emptyfield');
            }
            if (blng_city == "") {
                $('#blng_city').addClass('emptyfield');
            }
            if (blng_country == "") {
                $('#blng_country').addClass('emptyfield');
            }
            if (blng_state == "") {
                $('#blng_state').addClass('emptyfield');
            }
            if (blng_zipcode == "") {
            ...
            if (spng_street == "") {
                $('#spng_street').addClass('emptyfield');
            }
            if (spng_city == "") {
                $('#spng_city').addClass('emptyfield');
            }
            if (spng_country == "") {
                $('#spng_country').addClass('emptyfield');
            }
            if (spng_state == "") {
                $('#spng_state').addClass('emptyfield');
            }
            if (spng_zipcode == "") {
        ...
        else
        {
            ...
            if (lastname.match(letters))
            {
                ...
                {
                    alert("Please enter at least 2 characters for last name");
                    $('#lastname').addClass('emptyfield');
                    return false;
                }
            }
            ...
            $.ajax({
                ...
                success: function(response)
                {
                    ...
                    {
                        var post_url = "<?php echo site_url('products/getnewhash/'.$product_id); ?>";
                        $.ajax({
                            type: "post",
                            url: post_url,
