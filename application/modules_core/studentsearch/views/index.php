                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-3">
                            <select type="text" class="form-control qsbfield"  id="adv_sal_min" name="adv_sal_min">
                                ...
                                <option value="1000000">1,00,0000</option>
                                <option value="1000001">1,00,0000+</option>
...
<?php } ?>-->
                                ...
                                <option value="99000"><1,00,000</option>
                                <option value="100000">1,00,000</option>
                                <option value="200000">2,00,000</option>
                                <option value="300000">3,00,000</option>
                                <option value="400000">4,00,000</option>
                                ...
                                <option value="900000">9,00,000</option>
                                <option value="1000000">1,00,0000</option>
                                <option value="99999999999999">1,00,0000+</option>
                            </select>
                        </div>
...
if (!empty($result)) {
    ...
    foreach ($result as $res) {
                                ...
                                <div class="col-md-10">
                                    <a href="#">
                                        <span class="studentrole">
                                            <?php echo $res->role; ?> 
                                            <?php
                                            if ($res->resume_headline != "") {
                                                echo "/ " . $res->resume_headline;
                                            }
                                            ?>
        <?php
        if ($res->total_exp != "") {
            echo "(" . round($res->total_exp / 12, 2) . " yrs Exp.)";
        }
        ?>
                                        </span>
                                    </a>       
                                ...
                                <div>
                                    <a href="<?php echo site_url('sites/preview_profile/'.$this->encrypt->encode($res->site_id));?>" target="_blank">Preview Profile</a>
                                </div>
                            </div>
            ...
            <?php echo $row[0]->Company_name; ?>
                            ...
                            <div class="row margintop15px">
                                <div class="col-md-2">
                                    <span><img src="<?php echo base_url() . "assets/img/student_exp.png"; ?>"/>  <?php
                                if ($res->total_exp != "") {
                                    echo round($res->total_exp / 12, 2) . " yrs";
                                }
                                ?></span>
                                </div> 

                                <div class="col-md-10"> 
                                    <span><img src="<?php echo base_url() . "assets/img/student_location.png"; ?>"/>  <?php
                                    if ($res->location != "") {
                                        echo $res->location;
                                    }
                                    ?></span>
        ...
        <?php
        if ($res->salary != "") {
            echo "<i class='fa fa-inr'></i> " . $res->salary;
        } else {
            echo "Not disclosed";
        }
        ?>
                            ...
                            <div class="row margintop15px">
                                <div class="col-md-12 studentlastupdate">
                                    Last Updated: <?php
            if ($res->last_updated != "") {
                echo date('d/m/Y', $res->last_updated);
            }
            ?>
                                </div> 
                            </div>   
...
<div class="modal fade" id="myModalEmail" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog" role="document" style=" width: 668px;">
        <div class="modal-content">
            <div class="modal-header searchmodalheading">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
...
<?PHP $this->load->view('email/jobtemplete'); ?>
                        </textarea>
                    </div>
                </form>          
            </div>
