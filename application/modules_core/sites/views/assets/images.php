    ...
    $(function(){
    	...
    	/* view image in popup */
    	$('.images > .image .buttons .btn-primary, .images .imageWrap > a').click(function(e){
    		
    		e.preventDefault();
    		
    		theSrc = $(this).closest('.image').find('img').attr('src');
    	...
    	//delete image
    	$('#myImages').on("click", '.buttons .btn-danger', function(e){
    	
    		e.preventDefault();
    		
    		toDel = $(this).closest('.image');
    		theURL = $(this).attr('data-img');
