			...
			<div class="col-sm-12">
				<div class="col-sm-6" >
					<div class="form-group col-sm-11">
						...
						<input type="text" class="form-control" id="r_title" name="r_title" placeholder="Resume Title" value="<?php if( isset($resumeData['basic']) ){ echo $resumeData['basic']->resume_headline; }?>">
					</div>
					...
					<div class="form-group col-sm-11">
						...
						<textarea class="form-control" id="r_desc" name="r_desc" placeholder="Resume Description"><?php if( isset($resumeData['basic']) ){ echo $resumeData['basic']->summery; }?></textarea>
					</div>
					
					<div class="form-group col-sm-11">
						<label for="name" class=" control-label"><?php echo "Company/Organization";//echo $this->lang->line('modal_pagesettings_pagetitle')?>:</label>
						<input type="text" class="form-control" id="r_company" name="r_company" placeholder="Company/Organization Name" value="<?php if( isset($resumeData['basic']) ){ echo $resumeData['basic']->company; }?>">
					</div>		
								
					<div class="form-group col-sm-11">
						<label for="name" class="control-label"><?php echo "Current Job Role";//echo $this->lang->line('modal_pagesettings_pagetitle')?>:</label>
						<input type="text" class="form-control" id="r_role" name="r_role" placeholder="Current Role" value="<?php if( isset($resumeData['basic']) ){ echo $resumeData['basic']->role; }?>">
					</div>
					...
					<div class="form-group col-sm-11">
						...
						?>
						<select name="r_notice_p">
							<?PHP foreach ($notice_period as $k=>$v): ?>
								<option value="<?PHP echo $k; ?>" <?php if( isset($resumeData['basic']) ){ echo ($resumeData['basic']->notice_period==$k)?" selected":" "; }?>><?PHP echo $v; ?></option>
							<?PHP endforeach; ?>
						</select>
					</div>
				</div>
				<div class="col-sm-6">
					<div class="form-group col-sm-11">
						...
						<input type="text" class="form-control" id="r_clocaltion" name="r_clocaltion" placeholder="Current Location" value="<?php if( isset($resumeData['basic']) ){ echo $resumeData['basic']->location; }?>">
					</div>
					...
					<div class="form-group col-sm-11">
						...
						<input type="text" class="form-control" id="r_plocation" name="r_plocation" placeholder="Preferred Location" value="<?php if( isset($resumeData['basic']) ){ echo $resumeData['basic']->preff_location; }?>">
					</div>		
					<?PHP
						$salary_scale = array(
							"0"=>"< 1 Lakh",
					...
					<div class="form-group col-sm-11">
						...
						<select name="cctc">
							...
							<?PHP foreach ($salary_scale as $k=>$v): ?>
								<option value="<?PHP echo $k; ?>" <?php if( isset($resumeData['basic']) ){ echo (isset($resumeData['basic']->salary) && $resumeData['basic']->salary==$k)?" selected":" "; }?>><?PHP echo $v; ?></option>
							<?PHP endforeach; ?>
							<?PHP endif; ?>
						</select>
					</div>
					...
					<div class="form-group col-sm-11">
						...
						<select name="ectc">
							<?PHP foreach ($salary_scale as $k=>$v): ?>
								<option value="<?PHP echo $k; ?>" <?php if( isset($resumeData['basic']) ){ echo ($resumeData['basic']->expected_salary==$k)?" selected":" "; }?>><?PHP echo $v; ?></option>
							<?PHP endforeach; ?>
						</select>
					</div>
					...
					<div class="form-group col-sm-11">
						...
						<input type="number" min="0" class="form-control" id="r_tot_exp" name="r_tot_exp" placeholder="Total Experience" value="<?php if( isset($resumeData['basic']) ){ echo $resumeData['basic']->total_exp; }?>">
					</div>
				</div>
			</div>
			<div class="col-sm-12">
			...
			<div class="row">
				<div class="col-sm-12 inputpanel">
					<div class="col-sm-6">
						...
						<input type="text" name="degree" value="" placeHolder="Certificate/Degree"/>
					</div>
					<div class="col-sm-3">
				...
				<div class="col-sm-12 inputpanel">
					...
					<div class="col-sm-3">
						...
						<input type="text" name="per" value="" placeHolder="Percentage/Grade"/>
					</div>
					<div class="col-sm-3">
			...
			<div class="row">
				<div class="col-sm-12">
					<div class="col-sm-3">
						...
						<input type="text" name="skillname" value="" placeHolder="Skill Name"/>
					</div>
					<div class="col-sm-3">
					...
					<div class="col-sm-3">
						...
						<input type="number" name="rating" value="" placeHolder="Ratings (1 to 10)" min="1" max="10"/>
					</div>
					<div class="col-sm-3">
						<label for="name" class="control-label">&nbsp;<?php echo "";//echo $this->lang->line('modal_pagesettings_pagetitle')?></label>
			...
			<div class="row">
				<div class="col-sm-12">
					<div class="col-sm-4">
						...
						<input type="text" name="languagenm" placeHolder="Language Name"/>
					</div>
					<div class="col-sm-4">
						<label for="name" class="control-label"><?php echo "Ratings";//echo $this->lang->line('modal_pagesettings_pagetitle')?>:</label>
						<input type="number" name="rating" placeHolder="Ratings (1 to 10)" min="1" max="10"/>
					</div>
					<div class="col-sm-4">
						<label for="name" class="control-label">&nbsp;<?php echo " ";//echo $this->lang->line('modal_pagesettings_pagetitle')?></label>
