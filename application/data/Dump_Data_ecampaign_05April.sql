...
--
-- Host: localhost
-- Generation Time: Apr 05, 2016 at 07:18 AM
...
INSERT INTO `groups` (`id`, `name`, `description`, `visibility`) VALUES
(1, 'admin', 'Administrator', 0),
(2, 'sub-admin', 'Sub-Administrator', 0),
(3, 'comp-admin', 'Company Admin', 0),
(4, 'business', 'Business', 1),
(5, 'nogroup', 'No Group', 0),
(7, 'students', 'Students', 1),
(8, 'employer', 'Employer', 0),
(9, 'ecommerce', 'Ecommerce', 1),
(10, 'designer', 'Designer', 1);

--
-- Dumping data for table `plans_group`
--

INSERT INTO `plans_group` (`id`, `plan_id`, `group_id`) VALUES
(1, 1, 4),
(2, 2, 4),
(3, 3, 7),
(4, 4, 9),
...
INSERT INTO `price_plan` (`plan_id`, `name`, `description`, `price`, `discount_type`, `discount`, `expiration_type`, `expiration`, `recommended`, `status`, `visitor_count`, `eccommerce`, `premium_domain`, `no_of_sites`, `date_added`, `last_updated`, `deleted`) VALUES
(1, 'Basic', '<p>BUILD A BASIC WEBSITE</p><p>FREE SUB DOMAIN</p><p>ACCOUNT UPGRADE SUPPORT</p><p>SPONSOR ADVERTISEMENTS</p>', '0.0000', 'percentage', '0.0000', 'months', 2, 'no', 'active', 'active', '0', 'inactive', 1, '2015-06-16 00:00:00', '2016-03-07 10:41:40', 0),
(2, 'Business', '<p>FULL WEBSITES BUILDER</p><p>WEBSITE VISITOR ANALYTICS</p><p>EMAILS @ YOURDOMAINS NAME</p><p>SEO MANAGEMENT TOOL</p><p>FREE CUMSTOM DOMAIN</p><p>SEO, Analytics, Social Links</p><p>CUSTOMER SUPPORT</p>', '4990.0000', 'ammount', '0.0000', 'years', 1, 'no', 'active', 'active', '0', 'active', 3, '2015-06-16 00:00:00', '2016-03-07 13:21:33', 0),
(3, 'Professionals', '<p>INTERACTIVE RESUME BUILDER</p><p>RESUME VISITOR ANALYTICS</p><p>EMAILS @ YOURDOMAINS NAME</p><p>BRAND MANAGEMENT  TOOL</p><p>FREE CUSTOM DOMAIN</p><p>SEO, Analytics, Social Links</p><p>CUSTOMER SUPPORT</p>', '3490.0000', 'percentage', '5.0000', 'years', 1, 'yes', 'active', 'active', 'inactive', 'active', 1, '2016-01-22 17:48:57', '2016-02-16 04:49:36', 0),
(4, 'Ecommerce', '<p>E-COMMERCE BUILDER</p><p>WEBSITE VISITOR ANALYTICS</p><p>EMAILS @ YOURDOMAINS NAME</p><p>SEO MANAGEMENT TOOL</p><p>FREE CUSTOM  DOMAIN</p><p>SEO, Analytics, Social Links</p><p>CUSTOMER SUPPORT</p>', '9999.0000', 'percentage', '0.0000', 'years', 1, 'no', 'active', 'active', 'active', 'active', 1, '2016-02-15 17:30:17', '2016-02-16 04:43:53', 0),
(5, 'Designer', '<p>It''s plan specially created for Designer. </p>', '100.0000', 'percentage', '0.0000', 'years', 1, 'no', 'inactive', 'inactive', '0', 'inactive', 3, '2016-03-07 10:43:50', '2016-03-07 10:43:50', 0);

--
-- Dumping data for table `template_category`
--

INSERT INTO `template_category` (`category_id`, `category_name`) VALUES
(1, 'Art / Photography'),
(2, 'Business'),
(3, 'Construction'),
(4, 'Education'),
...
(1, '127.0.0.1', 'admin_webzero.in', '$2y$08$D6.LSRncG2TuLRN6qloG7eepWN78iQ6woQTXWjAgYtMiSc.GIA6zm', NULL, 'admin@webzero.in', NULL, NULL, NULL, NULL, 1455268925, 1459827771, 1, 'Administrator', NULL, NULL, NULL, NULL, NULL, NULL, 1);
